//
//  TopCountriesLargestAreaView.swift
...
struct TopCountriesLargestAreaView: View {
    ...
    var networkMonitor: NetworkMonitor
        ...
        var body: some View {
                VStack {
                    Text("Top 10 Largest Countries")
                        .font(.title)
                        .bold()
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .padding(.horizontal)
                        .padding(.top,20)
                    Text("List of top 10 largest countries by area")
                        .font(.subheadline)
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .padding(.horizontal)
                    ...
                    Chart(topCountries, id: \.id) { country in
                        ...
                        let scaledArea = Double(country.area) / 1000000
                        SectorMark(
                            angle: .value("Area", scaledArea),
                            angularInset: 1
                        )
